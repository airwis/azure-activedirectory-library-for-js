...
var AuthenticationContext = (function () {
     ...
     *  @property {function} modifyRenewUrl - User defined function to modify the navigation url for renewal, must return url. Defaults to 'null'.
    ...
    AuthenticationContext = function (config) {
        ...
        if (config.modifyRenewUrl && typeof config.modifyRenewUrl !== 'function') {
            throw new Error('modifyRenewUrl is not a function');
        }
    ...
    */
    ...
    AuthenticationContext.prototype._renewIdToken = function (callback, responseType) {
        ...
        if (this.config.modifyRenewUrl) {
            urlNavigate = this.config.modifyRenewUrl(urlNavigate);
        }
